    ...
    <script>
      ...
      <div class="container-fluid mt-3">
        <div id="licence_master">
          <div class="card">
            <h5 class="card-header"> Licence Master <button type="button" id="add" class="btn btn-secondary btn-sm float-right m-1">Add</button> </h5>
          </div>
          <div class="card">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                      <div class="form-row align-items-center">
                        Search For: &nbsp
                        <div class="col-auto">
                          <input type="text" class="form-control mb-2 ml-5" id="licence" placeholder="Jane Doe">
                        </div>
        ...
        <div id="add_licence" style="display: none;">
          <div class="card">
            <h5 class="card-header">Add Licence</h5>
            <div class="card-body">
              <form>

                <div class="form-group row">
                  <label for="licence_name" class="col-sm-2 col-form-label">Licence:</label>
                  <div class="col-sm-10">
                    <input type="text" required class="form-control" id="licence_name" >
                  </div>
                </div>

                <div class="form-group row">
                    <label for="grade_desc" class="col-sm-2 col-form-label">Comment:</label>
                    <div class="col-sm-10">
                      <textarea class="form-control" id="licence_comment" > </textarea>
                    </div>
                </div>
